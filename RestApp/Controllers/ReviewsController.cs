...
namespace RestApp.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            var reviewSet = db.ReviewSet.Include(r => r.Subject1);
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Email,Message,SubjectID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Email,Message,SubjectID")] Review review)
        {
            if (ModelState.IsValid)
            {
