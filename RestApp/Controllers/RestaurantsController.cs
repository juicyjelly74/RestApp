...
namespace RestApp.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,Image")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,Image")] Restaurant restaurant)
        {
            if (ModelState.IsValid)
            {
